...
echo "Installing TeX Live packages: pandoc texlive-latex-extra texlive-luatex texlive-science..."
sudo apt update
sudo apt install -y pandoc texlive-latex-extra texlive-luatex texlive-science
